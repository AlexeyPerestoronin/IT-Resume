...
В какой-то момент, совокупный опыт создания API между различными проектами Компании, позволил мне заметить, выделить и сформулировать новый паттерн проектирования API, который я назвал MinimalAPI.
